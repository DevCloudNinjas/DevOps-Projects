...
if [ "$project_name" != "project-53-supply-chain-security-lab" ]; then
  printf '%s
' "ERROR: expected project-53-supply-chain-security-lab; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-53-supply-chain-security-lab'
