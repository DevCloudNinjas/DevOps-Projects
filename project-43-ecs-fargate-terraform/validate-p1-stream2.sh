...
if [ "$project_name" != "project-43-ecs-fargate-terraform" ]; then
  printf '%s
' "ERROR: expected project-43-ecs-fargate-terraform; found $project_name" >&2
  exit 1
fi
...
' 'P1 project-43-ecs-fargate-terraform'
