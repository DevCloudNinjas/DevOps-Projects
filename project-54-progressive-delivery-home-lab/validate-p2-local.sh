...
if [ "$project_name" != "project-54-progressive-delivery-home-lab" ]; then
  printf '%s
' "ERROR: expected project-54-progressive-delivery-home-lab; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-54-progressive-delivery-home-lab'
