...
if [ "$project_name" != "project-20-azure-terraform-pipeline" ]; then
  printf '%s
' "ERROR: expected project-20-azure-terraform-pipeline; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-20-azure-terraform-pipeline'
