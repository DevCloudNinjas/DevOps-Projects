...
if [ "$project_name" != "project-14-github-actions-android" ]; then
  printf '%s
' "ERROR: expected project-14-github-actions-android; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-14-github-actions-android'
