...
and emits `evidence/validator-result.json`. Coverage: provenance/model-card/risk evidence; tampered hash and
incomplete approval. Inputs are deterministic checked-in fixtures; malformed, missing, contradictory, unsafe,
or incomplete records fail closed.
