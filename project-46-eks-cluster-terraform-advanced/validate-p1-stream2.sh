...
if [ "$project_name" != "project-46-eks-cluster-terraform-advanced" ]; then
  printf '%s
' "ERROR: expected project-46-eks-cluster-terraform-advanced; found $project_name" >&2
  exit 1
fi
...
' 'P1 project-46-eks-cluster-terraform-advanced'
