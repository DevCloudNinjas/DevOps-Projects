...
if [ "$project_name" != "project-07-azure-devops-aks-terraform" ]; then
  printf '%s
' "ERROR: expected project-07-azure-devops-aks-terraform; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-07-azure-devops-aks-terraform'
