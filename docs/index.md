...
<section class="showcase-grid">
  <div class="showcase-copy">
    <p class="section-kicker">Best first impression</p>
    <h2>Use the 2026 home labs when you want something current and repeatable.</h2>
    <p>
      These projects are designed for students who want realistic practice
      without guessing where to start. Each one has a validation command, a
      clearer README, and an explicit cleanup mindset.
    </p>
  </div>
  <div class="lab-list">
    <a href="https://github.com/DevCloudNinjas/DevOps-Projects/tree/master/project-50-argocd-gitops-home-lab">
      <span>50</span>
      <strong>ArgoCD GitOps Home Lab</strong>
      <em>Local GitOps workflow</em>
    </a>
    <a href="https://github.com/DevCloudNinjas/DevOps-Projects/tree/master/project-51-opentelemetry-observability-home-lab">
      <span>51</span>
      <strong>OpenTelemetry Observability</strong>
      <em>Tracing and metrics practice</em>
    </a>
    <a href="https://github.com/DevCloudNinjas/DevOps-Projects/tree/master/project-52-opentofu-aws-free-tier-lab">
      <span>52</span>
      <strong>OpenTofu AWS Free-Tier Lab</strong>
      <em>Cost-aware IaC workflow</em>
    </a>
    <a href="https://github.com/DevCloudNinjas/DevOps-Projects/tree/master/project-53-supply-chain-security-lab">
      <span>53</span>
      <strong>Supply Chain Security</strong>
      <em>SBOM, scanning, and signing</em>
    </a>
    <a href="https://github.com/DevCloudNinjas/DevOps-Projects/tree/master/project-54-progressive-delivery-home-lab">
      <span>54</span>
      <strong>Progressive Delivery</strong>
      <em>Canary release practice</em>
    </a>
  </div>
</section>
...
<section class="workflow-strip">
  <div>
    <span>1</span>
    <strong>Pick</strong>
    <p>Use the project picker to filter by cost, cloud, and deployability.</p>
  </div>
  <div>
    <span>2</span>
    <strong>Prepare</strong>
    <p>Read prerequisites, copy example configs, and keep credentials local.</p>
  </div>
  <div>
    <span>3</span>
    <strong>Validate</strong>
    <p>Run the project quality command before deploying anything.</p>
  </div>
  <div>
    <span>4</span>
    <strong>Prove</strong>
...
<section class="privacy-note">
  <strong>Static and student-owned.</strong>
  <span>
    This portal does not require accounts, forms, analytics, cookies, or shared
    credentials. Students use their own local tools and cloud accounts.
  </span>
</section>
