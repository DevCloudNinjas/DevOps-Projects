...
if [ "$project_name" != "project-41-online-boutique-microservices" ]; then
  printf '%s
' "ERROR: expected project-41-online-boutique-microservices; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-41-online-boutique-microservices'
