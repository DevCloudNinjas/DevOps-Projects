...
if [ "$project_name" != "project-50-argocd-gitops-home-lab" ]; then
  printf '%s
' "ERROR: expected project-50-argocd-gitops-home-lab; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-50-argocd-gitops-home-lab'
