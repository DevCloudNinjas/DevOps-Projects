...
if [ "$project_name" != "project-02-aws-vpc-architecture" ]; then
  printf '%s
' "ERROR: expected project-02-aws-vpc-architecture; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-02-aws-vpc-architecture'
