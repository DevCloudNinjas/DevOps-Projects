...
and emits `evidence/validator-result.json`. Coverage: ownership, dependencies, versioning; unsafe or
incomplete template. Inputs are deterministic checked-in fixtures; malformed, missing, contradictory, unsafe,
