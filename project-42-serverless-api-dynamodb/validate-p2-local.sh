...
if [ "$project_name" != "project-42-serverless-api-dynamodb" ]; then
  printf '%s
' "ERROR: expected project-42-serverless-api-dynamodb; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-42-serverless-api-dynamodb'
