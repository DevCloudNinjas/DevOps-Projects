...
if [ "$project_name" != "project-45-jenkins-cicd-argocd-vault" ]; then
  printf '%s
' "ERROR: expected project-45-jenkins-cicd-argocd-vault; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-45-jenkins-cicd-argocd-vault'
