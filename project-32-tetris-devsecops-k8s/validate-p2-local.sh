...
if [ "$project_name" != "project-32-tetris-devsecops-k8s" ]; then
  printf '%s
' "ERROR: expected project-32-tetris-devsecops-k8s; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-32-tetris-devsecops-k8s'
