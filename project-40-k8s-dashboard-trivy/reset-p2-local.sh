...
if [ "$project_name" != "project-40-k8s-dashboard-trivy" ]; then
  printf '%s
' "ERROR: expected project-40-k8s-dashboard-trivy; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-40-k8s-dashboard-trivy'
