...
if [ "$project_name" != "project-47-django-saas-ecommerce" ]; then
  printf '%s
' "ERROR: expected project-47-django-saas-ecommerce; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-47-django-saas-ecommerce'
