...
if [ "$project_name" != "project-37-eks-terraform-provision" ]; then
  printf '%s
' "ERROR: expected project-37-eks-terraform-provision; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-37-eks-terraform-provision'
