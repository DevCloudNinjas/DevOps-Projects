...
and emits `evidence/validator-result.json`. Coverage: ledger reconciliation, allocation gaps, forecast
variance, unit metric, owner/due date, closure evidence. Inputs are deterministic checked-in fixtures;
malformed, missing, contradictory, unsafe, or incomplete records fail closed.
