...
This record defines the active classroom path for `project-35-devsecops-pipeline-series`. It is source-only
and local-first: it must not require provider credentials, cloud accounts, external deployment, or destructive
lifecycle commands.
