...
if [ "$project_name" != "project-35-devsecops-pipeline-series" ]; then
  printf '%s
' "ERROR: expected project-35-devsecops-pipeline-series; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-35-devsecops-pipeline-series'
