...
if [ "$project_name" != "project-10-dotnet-azure-devops" ]; then
  printf '%s
' "ERROR: expected project-10-dotnet-azure-devops; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-10-dotnet-azure-devops'
