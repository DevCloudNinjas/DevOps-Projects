...
if [ "$project_name" != "project-34-node-cicd-ecs-terraform-gha" ]; then
  printf '%s
' "ERROR: expected project-34-node-cicd-ecs-terraform-gha; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-34-node-cicd-ecs-terraform-gha'
