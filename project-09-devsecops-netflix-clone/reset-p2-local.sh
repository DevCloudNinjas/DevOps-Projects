...
if [ "$project_name" != "project-09-devsecops-netflix-clone" ]; then
  printf '%s
' "ERROR: expected project-09-devsecops-netflix-clone; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-09-devsecops-netflix-clone'
