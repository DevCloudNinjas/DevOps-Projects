...
if [ "$project_name" != "project-06-advanced-cicd-pipeline" ]; then
  printf '%s
' "ERROR: expected project-06-advanced-cicd-pipeline; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-06-advanced-cicd-pipeline'
