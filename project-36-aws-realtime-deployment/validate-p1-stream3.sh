...
if [ "$project_name" != "project-36-aws-realtime-deployment" ]; then
  printf '%s
' "ERROR: expected project-36-aws-realtime-deployment; found $project_name" >&2
  exit 1
fi
...
' 'P1 project-36-aws-realtime-deployment'
