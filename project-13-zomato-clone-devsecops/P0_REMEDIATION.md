# P0 Local-First Remediation — Zomato Clone: Secure Deployment with DevSecOps CI/CD

## Scope

This record defines the active classroom path for `project-13-zomato-clone-devsecops`. It is source-only and
