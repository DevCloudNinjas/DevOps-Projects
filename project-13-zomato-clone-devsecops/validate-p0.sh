...
if [ "$project_name" != "project-13-zomato-clone-devsecops" ]; then
  printf '%s
' "ERROR: expected project-13-zomato-clone-devsecops; found $project_name" >&2
  exit 1
fi
...
' 'P0 project-13-zomato-clone-devsecops'
