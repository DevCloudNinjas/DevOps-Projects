...
4. Delete the provided `GNUmakefile` and replace it with [this updated Makefile](learning/devops-bootcamp/examples/ch6/provider-setup/Makefile) and [helper script](learning/devops-bootcamp/examples/ch6/provider-setup/.make-helper.sh). Run `make init` to initialize your repo.
