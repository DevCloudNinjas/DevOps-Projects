...
6. Use DevCloud Ninjas' recommended tag structure (outlined in 4.1.1) to create tags. Hit *Next*.
...
8. Use DevCloud Ninjas' recommended tag structure to create tags. Then click *Create load balancer*.
...
10. 6. Use DevCloud Ninjas' recommended tag structure (outlined in 4.1.1) to create tags. Hit *Next*.
...
- Licensing costs
- DevCloud Ninjas' POV/uses for Load Balancers
