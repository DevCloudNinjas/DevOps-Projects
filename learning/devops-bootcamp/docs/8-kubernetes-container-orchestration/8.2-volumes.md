...
2. Clone the [bootcamp repository](learning/devops-bootcamp/.git) if you haven't already and apply the simple PV definition yaml example from `examples/ch8/volumes/pv-definition.yaml`
