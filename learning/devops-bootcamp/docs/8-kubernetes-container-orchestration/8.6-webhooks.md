...
1. Clone the [bootcamp repository](learning/devops-bootcamp/.git) if you haven't already and navigate to the `examples/ch8/webhooks` folder for this exercise's files.
