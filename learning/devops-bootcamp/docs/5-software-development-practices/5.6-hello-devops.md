...
- [TeamQuery](learning/devops-bootcamp), a way for employees to give anonymous feedback
- [DevShops](learning/devops-bootcamp), a Slack Slash command for an office supply list
