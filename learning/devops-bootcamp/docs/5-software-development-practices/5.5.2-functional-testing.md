...
3. Use the starter code provided to test
    * The link in the bottom right corner of the homepage takes you to [the bootcamp introduction](https://bootcamp.devcloudninjas.com/#/1-introduction/1.0-overview)
