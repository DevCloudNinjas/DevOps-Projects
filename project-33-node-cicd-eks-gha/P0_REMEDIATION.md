# P0 Local-First Remediation — End-to-End CI/CD Pipeline for Simple Node App Deployment on EKS using GitHub Actions

## Scope

This record defines the active classroom path for `project-33-node-cicd-eks-gha`. It is source-only and
