...
if [ "$project_name" != "project-52-opentofu-aws-free-tier-lab" ]; then
  printf '%s
' "ERROR: expected project-52-opentofu-aws-free-tier-lab; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-52-opentofu-aws-free-tier-lab'
