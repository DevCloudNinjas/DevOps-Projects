...
if [ "$project_name" != "project-38-docker-terraform-3tier" ]; then
  printf '%s
' "ERROR: expected project-38-docker-terraform-3tier; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-38-docker-terraform-3tier'
