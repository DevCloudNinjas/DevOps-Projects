...
if [ "$project_name" != "project-18-jenkins-java-full-cicd" ]; then
  printf '%s
' "ERROR: expected project-18-jenkins-java-full-cicd; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-18-jenkins-java-full-cicd'
