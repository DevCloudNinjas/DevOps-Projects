...
if [ "$project_name" != "project-19-eks-jenkins-terraform" ]; then
  printf '%s
' "ERROR: expected project-19-eks-jenkins-terraform; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-19-eks-jenkins-terraform'
