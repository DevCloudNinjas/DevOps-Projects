...
if [ "$project_name" != "project-49-text-encryption-cybersecurity" ]; then
  printf '%s
' "ERROR: expected project-49-text-encryption-cybersecurity; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-49-text-encryption-cybersecurity'
