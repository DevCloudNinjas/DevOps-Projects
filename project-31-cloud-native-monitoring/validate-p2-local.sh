...
if [ "$project_name" != "project-31-cloud-native-monitoring" ]; then
  printf '%s
' "ERROR: expected project-31-cloud-native-monitoring; found $project_name" >&2
  exit 1
fi
...
' 'P2 project-31-cloud-native-monitoring'
