...
if [ "$project_name" != "project-11-aws-2tier-terraform" ]; then
  printf '%s
' "ERROR: expected project-11-aws-2tier-terraform; found $project_name" >&2
  exit 1
fi
...
' 'P1 project-11-aws-2tier-terraform'
