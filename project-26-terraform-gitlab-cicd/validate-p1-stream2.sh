...
if [ "$project_name" != "project-26-terraform-gitlab-cicd" ]; then
  printf '%s
' "ERROR: expected project-26-terraform-gitlab-cicd; found $project_name" >&2
  exit 1
fi
...
' 'P1 project-26-terraform-gitlab-cicd'
